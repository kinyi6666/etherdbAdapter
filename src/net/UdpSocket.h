...
#ifndef __EtherDB_Net_UdpSocket_H_
#define __EtherDB_Net_UdpSocket_H_
...
namespace EtherDB
{
	namespace Net
	{
		class AMNET_API UdpSocket : Noncopyable
		{
		public:
			...
			unsigned int getRemoteAddr() { return _remoteAddr;}
			unsigned short getRemotePort() { return _remotePort;}
			void setDestAddr(const InetAddress& localaddr);
...
#endif // !__EtherDB_Net_UdpSocket_H_
